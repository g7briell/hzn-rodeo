    ...
    return (
      <div className="container" style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflowY: 'auto' }}>
        <header className="header" style={{ position: 'sticky', top: 0, zIndex: 100, width: '100%', left: 0 }}>
          <div className="logo" style={{ cursor: 'pointer' }} onClick={() => navigateTo('/')}><img src="/logo_branca.png" alt="RodeoApp" style={{ height: "36px", objectFit: "contain" }} /></div>
    ...
    return (
      <>
        <div className="container">
          {/* Header */}
          <header className="header">
            <div className="logo" style={{ cursor: 'pointer' }} onClick={() => { setCurrentTab('home'); navigateTo('/'); }}><img src="/logo_branca.png" alt="RodeoApp" style={{ height: "36px", objectFit: "contain" }} /></div>
      ...
      <div className="dashboard-layout">
        ...
        <aside className="dashboard-sidebar">
          <div className="sidebar-logo">
            <img src="/logo_branca.png" alt="RodeoApp" style={{ height: "36px", objectFit: "contain" }} />
          </div>
